...
<table>
  <tr>
   ...
   <td>This QuickStart tutorial shows you how to embed search-driven analytics into your web application using the ThoughtSpot Visual Embed SDK.
   </td>
  </tr>
  <tr>
   <td><strong>URL</strong>
   </td>
   <td>build-reactjs-app-with-thoughtspot-and-snowflake \
