...
describe('Base TS Embed', () => {
    ...
    test('Should show an alert when third party cookie access is blocked', (done) => {
        ...
        jest.spyOn(window, 'alert').mockImplementation(() => {
            expect(window.alert).toBeCalledWith('Third party cookie access is blocked on this browser, please allow third party cookies for ThoughtSpot to work properly');
            done();
        });
    });
