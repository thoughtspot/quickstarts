...
describe('Unit test for process data', () => {
    ...
    test('ProcessData, when Action is CustomAction', async () => {
        ...
        expect(processDataInstance.getProcessData(EmbedEvent.CustomAction, processedData, thoughtSpotHost)).toStrictEqual(processedData);
    });
    test('ProcessData, when Action is non CustomAction', () => {
        ...
        processDataInstance.getProcessData(EmbedEvent.Data, processedData, thoughtSpotHost);
