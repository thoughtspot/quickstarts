...
describe('Pinboard/viz embed tests', () => {
    ...
    test('should set disabled actions', async () => {
        ...
        pinboardEmbed.render();
        await executeAfterWait(() => {
            expect(getIFrameSrc()).toBe(`http://${thoughtSpotHost}/?embedApp=true${defaultParams}&disableAction=[%22${Action.DownloadAsCsv}%22,%22${Action.DownloadAsPdf}%22,%22${Action.DownloadAsXlsx}%22]&disableHint=Action%20denied${prefixParams}#/embed/viz/${pinboardId}`);
        });
    });
    test('should set hidden actions', async () => {
        ...
        pinboardEmbed.render();
        await executeAfterWait(() => {
            expect(getIFrameSrc()).toBe(`http://${thoughtSpotHost}/?embedApp=true${defaultParams}&hideAction=[%22${Action.DownloadAsCsv}%22,%22${Action.DownloadAsPdf}%22,%22${Action.DownloadAsXlsx}%22]${prefixParams}#/embed/viz/${pinboardId}`);
        });
    });
    ...
    test('should render viz', async () => {
        ...
        pinboardEmbed.render();
        await executeAfterWait(() => {
            expect(getIFrameSrc()).toBe(`http://${thoughtSpotHost}/?embedApp=true${defaultParams}${prefixParams}#/embed/viz/${pinboardId}/${vizId}`);
        });
    });
    test('should apply runtime filters', async () => {
        ...
        pinboardEmbed.render();
        await executeAfterWait(() => {
            expect(getIFrameSrc()).toBe(`http://${thoughtSpotHost}/?embedApp=true&col1=sales&op1=EQ&val1=1000${defaultParams}${prefixParams}#/embed/viz/${pinboardId}/${vizId}`);
        });
    });
